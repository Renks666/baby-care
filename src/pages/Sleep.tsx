...
export function Sleep() {
  ...
  const { records, activeSleep, startSleep, stopSleep, deleteRecord } = useSleepStore()
    ...
    <>
      ...
      >
        ...
        <div className="pt-12 pb-4 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-gray-800">Сон</h1>
          </div>
        </div>
        ...
        {activeSleep && activeDef ? (
          ...
          <Card className="mb-4">
            <p className="text-sm text-gray-500 mb-4">Начать отслеживание сна</p>
            <Button
              fullWidth
              size="lg"
              className="bg-purple-500 hover:bg-purple-600 text-white"
            ...
            {todayRecords.map((r) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white rounded-xl p-3 border border-purple-50 flex items-center gap-3"
                >
      ...
      <Drawer open={startDrawerOpen} onClose={() => setStartDrawerOpen(false)} title="Начать сон">
        <div className="space-y-4 pb-2">
          <div>
            <p className="text-xs text-gray-500 font-medium mb-2">Тип сна</p>
